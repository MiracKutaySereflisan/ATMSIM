...
// this build speaks.
//
// Why it exists: docs/protocol.md is the single source of truth for what the two
...
// docs/protocol.md, this constant, and the book chapter that explains it.
...
{
    /// <summary>Must match the "Sürüm" line at the top of docs/protocol.md.</summary>
